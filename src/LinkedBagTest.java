...
System.out.println("");
		...
		BagInterface<String> bag5 = new LinkedBag<>();
		BagInterface<String> bag6 = new LinkedBag<>();
		bag6.add("b");		
		...
		BagInterface<String> bag7 = new LinkedBag<>();
		BagInterface<String> bag8 = new LinkedBag<>();
		...
		BagInterface<String> bag9 = new LinkedBag<>();
		...
		BagInterface<String> bag11 = new LinkedBag<>();
		BagInterface<String> bag12 = new LinkedBag<>();
		bag11.add("b");
		bag11.add("g");
		bag12.add("a");
		bag12.add(null);
		BagInterface<String> everything6 = bag11.union(bag12);
		assertEquals("Result Bag: a null b g ", "Result Bag: " + everything6);
	...
	public void intersectionTest() {
		...
		BagInterface<Integer> bag9 = new LinkedBag<>();
		BagInterface<Integer> bag10 = new LinkedBag<>();
		bag10.add(1);
		bag10.add(3);
		bag10.add(2);
		...
		BagInterface<Integer> bag11 = new LinkedBag<>();
		BagInterface<Integer> bag12 = new LinkedBag<>();
		bag11.add(1);
		bag11.add(3);
		bag11.add(2);
		...
		BagInterface<Integer> bag13 = new LinkedBag<>();
		BagInterface<Integer> bag14 = new LinkedBag<>();
		...
		BagInterface<Integer> bag15 = new LinkedBag<>();
